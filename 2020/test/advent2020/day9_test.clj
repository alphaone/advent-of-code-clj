...
(deftest solve-b
  (is (= {:size 4 :weakness [62]}
         (day9/solve-b 127 [35 20 15 25 47 40 62 55 65 95 102 117 150 182 127 219 299 277 309 576])))
  (is (= {:size 17 :weakness [245848639]}
         (day9/solve-b 2089807806 input))))
